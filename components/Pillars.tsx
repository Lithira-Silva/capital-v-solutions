...
export function Pillars() {
  return (
    <section id="pillars" className="min-h-screen flex items-center py-20 md:py-24 bg-gradient-to-b from-[#F8F7F3] via-[#F5F3ED] to-[#FEFDFB] relative overflow-hidden">
      {/* Premium Background Elements */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Primary gradient orb */}
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-gradient-to-br from-[#D4AF37]/10 via-[#D4AF37]/4 to-transparent rounded-full blur-3xl" />
          ...
          {pillars.map((pillar, index) => (
            ...
            >
              <div className="relative h-full bg-white/40 backdrop-blur-2xl border-2 border-[#D4AF37]/30 rounded-3xl p-6 lg:p-8 transition-all duration-500 hover:border-[#D4AF37]/60 hover:shadow-[0_8px_30px_rgba(212,175,55,0.15),0_0_60px_rgba(212,175,55,0.1)] hover:-translate-y-2">
                ...
                <div className="absolute top-6 right-6 font-heading text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] to-[#B38728] opacity-25 group-hover:opacity-40 transition-all duration-500 select-none">
